/* BizICE Cost Manager — Service Worker (L2 read-only PWA cache)
   ─────────────────────────────────────────────────────────────
   Strategy:
   • App shell (HTML, JS, CSS, images) → network-first + cache fallback
...
const CACHE_VERSION = 'bizice-cost-v__APP_VERSION__'
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
...
// 🔄 รับคำสั่ง skip waiting จาก client
